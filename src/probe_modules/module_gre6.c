...
int gre6_global_initialize(struct state_conf *conf)
{
	...
	if (asprintf((char **restrict)&module_gre6.pcap_filter,
		     "%s && ip6 dst host %s", module_gre6.pcap_filter,
...
static int gre6_init_perthread(void *buf, macaddr_t *src, macaddr_t *gw,
...
static int gre6_make_packet(void *buf, size_t *buf_len,
...
static void gre6_print_packet(FILE *fp, void *packet)
{
...
static int gre6_validate_packet(const struct ip *ip_hdr, uint32_t len,
...
static void gre6_process_packet(const u_char *packet,
...
probe_module_t module_gre6 = {
    ...
    .port_args = 0,
    .global_initialize = &gre6_global_initialize,
    .thread_initialize = &gre6_init_perthread,
    .make_packet = &gre6_make_packet,
    .print_packet = &gre6_print_packet,
    .process_packet = &gre6_process_packet,
    .validate_packet = &gre6_validate_packet,
    .close = NULL,
    .fields = fields,
    .numfields = 7};
