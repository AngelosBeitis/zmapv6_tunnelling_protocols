...
probe_module_t module_ip6ip6_spoofing;
...
static int
ip6ip6_spoofing_init_perthread(void *buf, macaddr_t *src, macaddr_t *gw,
...
static int ip6ip6_spoofing_make_packet(void *buf, size_t *buf_len,
				       ...
				       UNUSED int probe_num, UNUSED void *arg)
{
	...
	ip6_header2->ip6_src = ((struct in6_addr *)arg)[2]; //Spoofing address
...
static void ip6ip6_spoofing_print_packet(FILE *fp, void *packet)
{
...
static int ip6ip6_spoofing_validate_packet(const struct ip *ip_hdr,
					   uint32_t len,
...
static void ip6ip6_spoofing_process_packet(const u_char *packet,
...
probe_module_t module_ip6ip6_spoofing = {
    ...
    .port_args = 0,
    .global_initialize = &ip6ip6_spoofing_global_initialize,
    .thread_initialize = &ip6ip6_spoofing_init_perthread,
    .make_packet = &ip6ip6_spoofing_make_packet,
    .print_packet = &ip6ip6_spoofing_print_packet,
    .process_packet = &ip6ip6_spoofing_process_packet,
    .validate_packet = &ip6ip6_spoofing_validate_packet,
    .close = NULL,
    .fields = fields,
    .numfields = 7};
