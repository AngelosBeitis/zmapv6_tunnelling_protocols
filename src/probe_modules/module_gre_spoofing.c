...
probe_module_t module_gre_spoofing;
...
static int gre_spoofing_init_perthread(void *buf, macaddr_t *src,
...
static int gre_spoofing_make_packet(void *buf, size_t *buf_len,
...
static void gre_spoofing_print_packet(FILE *fp, void *packet)
{
...
static int gre_spoofing_validate_packet(const struct ip *ip_hdr, uint32_t len,
...
static void gre_spoofing_process_packet(const u_char *packet,
...
probe_module_t module_gre_spoofing = {
    ...
    .port_args = 0,
    .global_initialize = &gre_spoofing_global_initialize,
    .thread_initialize = &gre_spoofing_init_perthread,
    .make_packet = &gre_spoofing_make_packet,
    .print_packet = &gre_spoofing_print_packet,
    .process_packet = &gre_spoofing_process_packet,
    .validate_packet = &gre_spoofing_validate_packet,
    .close = NULL,
    .fields = fields,
    .numfields = 7};