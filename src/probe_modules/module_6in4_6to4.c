...
probe_module_t module_6in4_6to4;

int sixIn4_6to4_global_initialize(struct state_conf *conf)
{
	if(!zconf.external_address_v6){
		log_error("6in4_6to4", "External IPv6 address was not given. Add --external-ipv6-address");
		return EXIT_FAILURE;
	}
	return EXIT_SUCCESS;
}

static int sixIn4_6to4_init_perthread(void *buf, macaddr_t *src, macaddr_t *gw,
...
static int sixIn4_6to4_make_packet(void *buf, size_t *buf_len,
				   ...
				   UNUSED int probe_num, void *arg)
{
	...
	four_to_six2(dst_ip, &ip6_header->ip6_src);
...
static void sixIn4_6to4_print_packet(FILE *fp, void *packet)
{
...
static int sixIn4_6to4_validate_packet(const struct ip *ip_hdr, uint32_t len,
...
static void sixIn4_6to4_process_packet(const u_char *packet,
...
probe_module_t module_6in4_6to4 = {
    ...
    .port_args = 0,
    .global_initialize = &sixIn4_6to4_global_initialize,
    .thread_initialize = &sixIn4_6to4_init_perthread,
    .make_packet = &sixIn4_6to4_make_packet,
    .print_packet = &sixIn4_6to4_print_packet,
    .process_packet = &sixIn4_6to4_process_packet,
    .validate_packet = &sixIn4_6to4_validate_packet,
    .close = NULL,
    .fields = fields,
    .numfields = 7};